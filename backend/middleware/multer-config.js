...
const storage = multer.diskStorage({
    ...
    // On dit à multer quel nom de fichier on utilise
    filename: (req, file, callback) => {

        // On génère un nouveau nom avec le nom d'origine, on supprime les espaces (white space avec split)
        //et on insère des underscores à la place
